					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide dark">
							...
							<div class="video-wrap">
								<img src="images/slider/ORFEYF0.jpg">
							</div>
						</div>
						<div class="swiper-slide dark" style="background-image: url('images/slider/slide1.jpg'); background-position: center top;">
							</div>
						<div class="swiper-slide dark" style="background-image: url('images/slider/slide.jpg'); background-position: center top;">
						</div>
					</div>	
					</div>
					...
					<div class="row clearfix">
						...
						<div class="col-lg-5">
							<div class="heading-block topmargin">
								<h1>Welcome to <br>Learning Mate</h1>
							</div>
							<p class="lead">We are a group of educators; our aim is to promote education. If you are a student, then contact us to secure your future. We deliver free international standard video lectures and content. We are also providing services in Web &amp; Software Development.</p>
						</div>

						<div class="col-lg-7">

							<div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
								<img src="images/services/3784896.jpg" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="100" alt="Chrome">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container clear-bottommargin clearfix">
						...
						<div class="row topmargin-sm clearfix">
							...
							<div class="col-md-4 bottommargin">
								...
								<p>We are here for achieve your expectations. Our professional educators have care about your product. They are positive, willing to go the distance to get the job done and bring their best every day.</p>
							</div>
				...
				<div class="container clearfix" id="features">
					...
					<div class="row topmargin-lg bottommargin-sm">
						...
						<div class="col-md-4 hidden-sm bottommargin center">
							<img src="images/services/bulb.png" alt="iphone 2">
						</div>
