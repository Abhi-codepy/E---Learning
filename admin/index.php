...
<head>
	...
	<link rel="icon" type="image/png" href="images/logotab.png" sizes="32x32">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap nopadding">
				...
				<div class="section nopadding nomargin" style="width: 100%; height: 100%; position: absolute; left: 0; top: 0; background: url('../images/ORFEYF0.jpg') center center no-repeat; background-size: cover;"></div>

				<div class="section nobg full-screen nopadding nomargin">
					<div class="container vertical-middle divcenter clearfix">

						<div class="panel panel-default divcenter noradius noborder" style="max-width: 400px; background-color:floralwhite;">
							<div class="panel-body" style="padding: 20px;">
								<div class="row center">
							<a href="index.php"><img height="90px" src="../images/logolm.png" alt="Learning Mate"></a>
						</div>
